...
public class SelectAction implements ActionListener {
	...
	// 생성자
	public SelectAction(JPanel bigPanel, JPanel yellowBorderPanel, User userInfo) {
...
//				
			...
			System.out.println("Seat.tempSeatRoomNo.equals(\"-1\") "+ Seat.tempSeatRoomNo.equals("-1"));
			System.out.println("userInfo.getUserType() :"+ userInfo.getUserType()+"...");
		
			// 좌석 선택 확인창
			if (Seat.tempSeatRoomNo.equals("-1") && userInfo.getUserType().equals("")) {
