...
public class KeyPadSignUp {
	...
	protected JTextField textCert;
	protected JTextField textID;
	protected JTextField textOnPW;
	protected JPasswordField textPW;
	protected JPasswordField textPW2;
	protected JTextField textCheckOutID; // 인증번호 4자리
	...
	public KeyPadSignUp(JFrame frame, JPanel backPanel) {
		this.frame = frame;
