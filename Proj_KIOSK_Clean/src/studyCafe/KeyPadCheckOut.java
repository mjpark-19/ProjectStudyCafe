...
//         lblCurrentTime2.setText(timeCal.timeInfo( userInfo.getFreeADayPassTime(), userInfo.getStartTime() )[0]);
         ...
         if ( userInfo.getUserType() == "hour" ) {
            userInfo.setFreeADayPassTime( timeCal.timeInfo( userInfo.getFreeADayPassTime().replace(";", ""), userInfo.getStartTime() )[1] );
            lblUsedTime2.setText(userInfo.getFreeADayPassTime());
            
         }else if ( userInfo.getUserType() == "time" ) {
            System.out.println("*****");
            userInfo.setFreeDaysPassTime( timeCal.timeInfo( userInfo.getFreeDaysPassTime().replace(";", ""), userInfo.getStartTime() )[1] ); 
            lblUsedTime2.setText(userInfo.getFreeDaysPassTime());
            
         }else if ( userInfo.getUserType() == "week" ) {

         }else if ( userInfo.getUserType() == "group") {
            userInfo.setGroupADayPassTime( timeCal.timeInfo( userInfo.getGroupADayPassTime().replace(";", ""), userInfo.getStartTime() )[1] );
